...
overages = OveragesUnderages(
    ...
    resolution_request=Resolution.DEBIT_ACCOUNT
)
...
with open(os.path.join('examples', 'hda_1_1A_overage_keep_product_report.json'), 'w') as f:
    f.write(exception_report.model_dump_json())

with open(os.path.join('examples', 'hda_1_1A_overage_keep_product_response.json'), 'w') as f:
